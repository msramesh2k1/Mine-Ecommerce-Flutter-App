                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (_) => CategoryLord(
                                    category: snapshots.data!.docs[index]['name'].toString().toUpperCase(),
                                )));
                        },
                        child: Container(
                          child: Column(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (_) => CategoryLord(category: snapshots.data!.docs[index]['name'].toString().toUpperCase(),)));
                        },
                        child: Container(
                          child: Column(
                            children: [
