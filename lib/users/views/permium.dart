...
class PermiumScreen extends StatefulWidget {
  const PermiumScreen({Key? key}) : super(key: key);

  @override
  State<PermiumScreen> createState() => _AllItemsScreenState();
}

class _AllItemsScreenState extends State<PermiumScreen> {
        ...
        body: Container(
          ...
          child: StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                .collection("SearchProducts").where(
                  "permium" , isEqualTo: true
                )
                .snapshots(),
