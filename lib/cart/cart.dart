...
//   const cart({Key? key, required this.cartno}) : super(key: key);
...
//         onPressed: () {
//           // Route route =
//           //     MaterialPageRoute(builder: (c) => Address(totalAmount: 2));
...
//                                                                         // setState(
//                                                                         //     () {
//                                                                         //   if (snapshot.data!.docs[index]['quanity'] >=
//                                                                         //       2) {
